...
Chrome/Chromium users can install it straight from the Chrome Web Store. For a manual install, or on Firefox, grab the latest release.

### Chromium (Chrome, Brave, Edge, etc.)

#### The latest version is available on the [Chrome Web Store](https://chromewebstore.google.com/detail/graytist/bflnfmllkbhilogfbdilcckpkfganelc)

Manual Installation:

1. Download `graytist-1.1.0-chrome.zip` from the [latest release](https://github.com/welcome-to-the-sunny-side/graytist/releases/latest) and unzip it.
...
1. Download `graytist-1.1.0-firefox.xpi` from the [latest release](https://github.com/welcome-to-the-sunny-side/graytist/releases/latest).
